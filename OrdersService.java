...
public class OrdersService implements Service {
  ...
  public void submitOrder(final OrderBean order,
    ...
    // TODO 1.1: create a new  with a key specified by  and value of the bean, to the orders topic whose name is specified by 
    // ...
    producer.send(new ProducerRecord<>(ORDERS.name(), bean.getId(), bean);
    // TODO 1.2: produce the newly created record using the existing  and pass use the  function to send the  and the record key
    // ...
